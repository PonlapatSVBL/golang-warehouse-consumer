...
type DocsStruct struct {
	...
	HolidayChangeCount                     uint32 `json:"holiday_change_count" db:"holiday_change_count"`
	HolidayChangeDisapproveCount           uint32 `json:"holiday_change_disapprove_count" db:"holiday_change_disapprove_count"`
	OtWorkCount                            uint32 `json:"ot_work_count" db:"ot_work_count"`
	OtWorkDisapproveCount                  uint32 `json:"ot_work_disapprove_count" db:"ot_work_disapprove_count"`
	TimeAdjustCount                        uint32 `json:"time_adjust_count" db:"time_adjust_count"`
	TimeAdjustDisapproveCount              uint32 `json:"time_adjust_disapprove_count" db:"time_adjust_disapprove_count"`
	TimeLeaveCount                         uint32 `json:"time_leave_count" db:"time_leave_count"`
	TimeLeaveDisapproveCount               uint32 `json:"time_leave_disapprove_count" db:"time_leave_disapprove_count"`
	TimeLeave01Count                       uint32 `json:"time_leave_01_count" db:"time_leave_01_count"`
	TimeLeave02Count                       uint32 `json:"time_leave_02_count" db:"time_leave_02_count"`
	TimeLeave03Count                       uint32 `json:"time_leave_03_count" db:"time_leave_03_count"`
	TimeLeave04Count                       uint32 `json:"time_leave_04_count" db:"time_leave_04_count"`
	TimeLeave05Count                       uint32 `json:"time_leave_05_count" db:"time_leave_05_count"`
	TimeLeave06Count                       uint32 `json:"time_leave_06_count" db:"time_leave_06_count"`
	TimeLeave07Count                       uint32 `json:"time_leave_07_count" db:"time_leave_07_count"`
	TimeLeave08Count                       uint32 `json:"time_leave_08_count" db:"time_leave_08_count"`
	TimeLeave09Count                       uint32 `json:"time_leave_09_count" db:"time_leave_09_count"`
	TimeLeave10Count                       uint32 `json:"time_leave_10_count" db:"time_leave_10_count"`
	TimeLeave11Count                       uint32 `json:"time_leave_11_count" db:"time_leave_11_count"`
	TimeLeave12Count                       uint32 `json:"time_leave_12_count" db:"time_leave_12_count"`
	TimeLeave13Count                       uint32 `json:"time_leave_13_count" db:"time_leave_13_count"`
	TimeLeave14Count                       uint32 `json:"time_leave_14_count" db:"time_leave_14_count"`
	TimeLeave15Count                       uint32 `json:"time_leave_15_count" db:"time_leave_15_count"`
	TimeLeave16Count                       uint32 `json:"time_leave_16_count" db:"time_leave_16_count"`
	TimeLeave17Count                       uint32 `json:"time_leave_17_count" db:"time_leave_17_count"`
	TimeLeave18Count                       uint32 `json:"time_leave_18_count" db:"time_leave_18_count"`
	TimeLeave19Count                       uint32 `json:"time_leave_19_count" db:"time_leave_19_count"`
	TimeLeave20Count                       uint32 `json:"time_leave_20_count" db:"time_leave_20_count"`
	WorkCycleChangeCount                   uint32 `json:"work_cycle_change_count" db:"work_cycle_change_count"`
	WorkCycleChangeDisapproveCount         uint32 `json:"work_cycle_change_disapprove_count" db:"work_cycle_change_disapprove_count"`
	WithdrawDocCount                       uint32 `json:"withdraw_doc_count" db:"withdraw_doc_count"`
	WithdrawDocDisapproveCount             uint32 `json:"withdraw_doc_disapprove_count" db:"withdraw_doc_disapprove_count"`
	PettyCashCount                         uint32 `json:"petty_cash_count" db:"petty_cash_count"`
	PettyCashDisapproveCount               uint32 `json:"petty_cash_disapprove_count" db:"petty_cash_disapprove_count"`
	SalaryCertificateLetterCount           uint32 `json:"salary_certificate_letter_count" db:"salary_certificate_letter_count"`
	SalaryCertificateLetterDisapproveCount uint32 `json:"salary_certificate_letter_disapprove_count" db:"salary_certificate_letter_disapprove_count"`
	WorkCertificateLetterCount             uint32 `json:"work_certificate_letter_count" db:"work_certificate_letter_count"`
	WorkCertificateLetterDisapproveCount   uint32 `json:"work_certificate_letter_disapprove_count" db:"work_certificate_letter_disapprove_count"`
	WelfareCount                           uint32 `json:"welfare_count" db:"welfare_count"`
	WelfareDisapproveCount                 uint32 `json:"welfare_disapprove_count" db:"welfare_disapprove_count"`
	ComplaintCount                         uint32 `json:"complaint_count" db:"complaint_count"`
	ComplaintDisapproveCount               uint32 `json:"complaint_disapprove_count" db:"complaint_disapprove_count"`
}
